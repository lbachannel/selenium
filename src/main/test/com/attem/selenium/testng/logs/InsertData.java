...
public class InsertData extends TestData implements Log<InsertData>{
	private String id;
	...
	@Override
	public void writeLog(String src, String sheetName, Set<InsertData> ups) throws IOException {
	...
	@Override
	public void writeDataRow(InsertData say, Row row, XSSFSheet sheet) throws IOException {
