...
public class DeleteData extends TestData implements Log<DeleteData>{
	private String id;
	...
	@Override
	public void writeLog(String src, String sheetName, Set<DeleteData> logs) throws IOException {
	...
	@Override
	public void writeDataRow(DeleteData log, Row row, XSSFSheet sheet) throws IOException {
